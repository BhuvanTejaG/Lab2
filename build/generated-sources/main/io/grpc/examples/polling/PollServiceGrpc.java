...
public class PollServiceGrpc {
  ...
  private static final io.grpc.stub.Method<io.grpc.examples.polling.PollRequest,
      io.grpc.examples.polling.PollResponse> METHOD_CREATE_POLL =
  ...
  public static class PollServiceServiceDescriptor extends
    ...
    public final io.grpc.MethodDescriptor<io.grpc.examples.polling.PollRequest,
        io.grpc.examples.polling.PollResponse> createPoll;

    private PollServiceServiceDescriptor() {
      createPoll = createMethodDescriptor(
          "io.grpc.examples.polling.PollService", METHOD_CREATE_POLL);
    }

    @SuppressWarnings("unchecked")
    private PollServiceServiceDescriptor(
        java.util.Map<java.lang.String, io.grpc.MethodDescriptor<?, ?>> methodMap) {
      createPoll = (io.grpc.MethodDescriptor<io.grpc.examples.polling.PollRequest,
  ...
  public static interface PollService {
    ...
    public void createPoll(io.grpc.examples.polling.PollRequest request,
  ...
  public static interface PollServiceBlockingClient {
    ...
    public io.grpc.examples.polling.PollResponse createPoll(io.grpc.examples.polling.PollRequest request);
  }

  public static interface PollServiceFutureClient {

    public com.google.common.util.concurrent.ListenableFuture<io.grpc.examples.polling.PollResponse> createPoll(
  ...
  public static io.grpc.ServerServiceDefinition bindService(
    ...
    return io.grpc.ServerServiceDefinition.builder("io.grpc.examples.polling.PollService")
